                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="mb-2">
                            ...
                            <div class="input-icon">
                                ...
                                <input type="email" name="email" id="email" class="form-control form-control-lg" placeholder="Enter Email" required autofocus>
                                @error('email')
                        ...
                        <div class="mb-2">
                            ...
                            <div class="input-icon">
                                ...
                                <input type="password" name="password" id="password" class="form-control form-control-lg pass-input" placeholder="Enter Password">
